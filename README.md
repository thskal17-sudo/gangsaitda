...
| 위치 | 내용 |
|---|---|
| `app/page.tsx` | 홈 화면 (첫인사, 오늘 올라온 공고 수, 마감이 가까운 공고 5개, 바로가기) |
| `app/jobs/page.tsx` | 공고 목록 화면 (`?view=today` 면 오늘 올라온 공고만) |
...
| `lib/request-schema.ts`, `lib/request-actions.ts` | 강사섭외 의뢰서 입력 규칙·보내기 |
